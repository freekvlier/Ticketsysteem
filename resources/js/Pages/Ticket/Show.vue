    ...
    <AuthenticatedLayout>
      <template #header>
        <div class="flex justify-between items-center">
          ...
          >
          <h2
            class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mx-auto"
          >
            Ticket Details
          </h2>
        </div>
      ...
      <div class="py-12">
        <div class="flex flex-col gap-7 max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <div
            v-for="reply in ticket.replies.slice().reverse()"
            :key="reply.id"
          >
          ...
          >
            <div class="p-6 text-gray-900 dark:text-gray-100">
              <h2
                class="text-center font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mx-auto"
              >
                Ticket {{ ticket.id }}
              </h2>
              <div class="mb-4">
