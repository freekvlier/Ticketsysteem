<template>
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <form @submit.prevent="submitReply">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="attachment" v-on:change="handleFileChange" multiple class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
  ...
  const handleFileChange = (event: Event) => {
        ...
        if (files) {
            reply.attachments = Array.from(files);
        }
    };
